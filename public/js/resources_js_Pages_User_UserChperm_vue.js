"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Pages_User_UserChperm_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapState)('User', ['allPermissions', 'user'])), (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)('User', ['users', 'groups'])),
  methods: {
    submitForm: function submitForm() {
      ...
      if (!this.errors.length) {
        ...
        var urlToUp = "/api/user/chperm/" + this.idEdit;
        _api_httpClient__WEBPACK_IMPORTED_MODULE_0__["default"].put(urlToUp, formData).then(function (response) {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_v_flex, {
    xs12: "",
    sm8: "",
    md4: ""
  }, {
