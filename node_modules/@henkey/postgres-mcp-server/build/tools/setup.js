...
function generateSetupInstructions(input) {
...
export const getSetupInstructionsTool = {
    ...
    async execute(params, _getConnectionString) {
        ...
        try {
            ...
            const outputText = `Installation Steps:\n${instructions.steps.join('\n')}\n
